...
public class ContinuousClassifier extends ThreadBase {
    ...
    /**
     * URL address of the buffer server
     */
    private String bufferHost;
    /**
     * Port of the buffer server
     */
    private int bufferPort;
    /**
     * Type of the event that ends the classification
     */
    private String endType;
    /**
     * Value of the event that ends the classificiation
     */
    private String endValue;
    /**
     * Type of the event that starts/stops the baseline phase
     */
    private String baselineEventType;
    /**
     * Value of the event that stops the baseline phase
     */
    private String baselineEnd;
    /**
     * Value of the event that starts the baseline phase
     */
    private String baselineStart;
    /**
     * Type of the events that are generated by the classifier
     */
    private String predictionEventType;
    /**
     * Data points between each baseline update
     */
    ...
    /**
     * Filter on the output values
     */
    private Double predictionFilter;
    /**
     * Length of the samples in ms.
     * Either set this value or the sampleTrialLength value.
     */
    private Integer sampleTrialMs;
    /**
     * Length of the samples in datapoints.
     * Either set this value or the sampleTrialMS value.
     */
    private Integer sampleTrialLength;
    /**
     * Duration between the samples in ms.
     * Either set this value or the sampleStep value.
     */
    private Integer sampleStepMs;
    /**
     * Duration between the samples in steps.
     * Either set this value or the sampleStepMs value.
     */
    private Integer sampleStep;
    /**
     * Timeout for waiting on data
     */
    private Integer timeoutMs;
    /**
     * Type of alpha output to use.
     * Used values are in C: C.ALPHA_LAT, C.ALPHA_POWER, C.ALPHA_NORM_LAT.
     */
    private String alphaType;
    /**
     * Classifiers to apply on the data. Output of the classifiers is added together.
     */
    private List<Classifier> classifiers;
    /**
     * Connection to the buffer server
     */
    private BufferClientClock clock;
    /**
     * Sampling rate of the buffer server.
     */
    private Float fs;
    /**
     * Header of the buffer server.
     */
